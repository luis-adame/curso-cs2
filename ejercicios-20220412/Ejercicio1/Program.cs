...
public static class Products
{
    ...
    public static void Exercise1()
    {
        var query = ProductList
            .Where(x => x.Category.Equals("Seafood"))
            .FirstOrDefault();

        Console.WriteLine($"Primer elemento de la categoria Seafood: {query}");
    }
    // Precio promedio de productos por categoria
    ...
    public static void Exercise3()
    {
        ...
        Console.WriteLine($"Numero de productos: {query}");
    }
    ...
    {
        var query = ProductList
            .Where(x => x.ProductName.Length == ProductList.Max(x => x.ProductName.Length));
    ...
    {
        var query = ProductList
            .Where(x => x.ProductName.Split().Length == ProductList.Max(x => x.ProductName.Split().Length));
    ...
    {
        var query = ProductList
            .Where(x => (x.UnitPrice * x.UnitsInStock) == ProductList.Max(x => x.UnitPrice * x.UnitsInStock));
